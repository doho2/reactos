...
macro(set_cpp)
    ...
    if(__cppopts_WITH_STL)
        ...
        if(USE_LIBCPP)
            # libc++
            # add_definitions(-D_LIBCPP_NATIVE_C_INCLUDE_PATH=${REACTOS_SOURCE_DIR}/sdk/include/crt)
            include_directories(${REACTOS_SOURCE_DIR}/sdk/include/libc++)
        else()
            # MSVC: stlport / GCC: libstdc++ from RosBE
            if(MSVC)
